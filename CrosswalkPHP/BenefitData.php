...
$row = 1;
if (($handle = fopen('DataSummaryOption/BenefitData.csv', 'r')) !== FALSE){
    echo '<div >';
    ...
    //  if ( $data!== FALSE ){
       // echo '<tr><th class="fixed-side">'.implode('</th><th class="fixed-side">', $data).'</th></tr>';
        ...
        echo '<th class="fixed-side">Total Benefits Paid</th>';
        echo '<th class="fixed-side">First Payments</th>';
        echo '<th class="fixed-side">Average Weekly Benefit</th>';
        echo '<th class="fixed-side">Average Benefits Per First Pay</th>';
        echo '</tr>';
        echo '</thead>';
    // }
    // Get the rest
